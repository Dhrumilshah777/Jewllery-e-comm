...
const Home = () => {
  ...
  const newestCollectionSettings = {
    dots: true,
    infinite: Math.min(newestProducts.length, 4) > slidesForWidth(viewportWidth),
    speed: 500,
    slidesToShow: slidesForWidth(viewportWidth),
    slidesToScroll: 1,
  ...
  return (
    <div className="space-y-12">
      ...
      <section className="py-16 px-2 md:px-6 mb-12">
      ...
      <section className="px-4 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <Slider key={`newest-${slidesForWidth(viewportWidth)}-${newestProducts.length}`} {...newestCollectionSettings}>
